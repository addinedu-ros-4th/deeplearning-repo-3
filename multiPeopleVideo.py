...
class MideapipeBody:
    def __init__(self):
        ...
        model_path = "../data/mediapipe/pose_landmarker_lite.task"
    ...
    def draw_landmarks_on_image(self, rgb_image, detection_result):
        ...
        for idx in range(len(self.pose_landmarks_list)):
            ...
            # print(pose_landmarks_proto.landmark[10].x)
    ...
    #                 cv2.imshow("MediaPipe Pose Landmark", self.to_window)
